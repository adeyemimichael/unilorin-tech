...
const Highlight = () => {
 ...
 <h2 className='font-brico md:font-semibold font-normal text-center md:text-[72px] text-[32px] p-8 w-screen '> Highlights for UTS 2023</h2>
  <div className="md:w-full  w-screen h-fit relative  md:left-0  left-0  ">
      ...
      <Slider {...settings}>
        <div className=" flex justify-center items-center overflow-hidden text-white text-center  bg-gray-300 md:w-[200px] md:h-[300px]  w-[300px] h-[260px]   ">
<img src={image0} alt="" className="w-full h-full object-fit " />
        </div>
        <div className=" flex justify-center items-center  text-white text-center bg-gray-300  md:w-[200px] md:h-[300px]  w-[300px] h-[260px] mx-10">
        <img src={image6} alt="" className="w-full h-full object-fit " />
        </div>
        <div className=" flex justify-center items-center  text-white text-center  bg-gray-300  md:w-[200px] md:h-[300px]  w-[300px] h-[260px] ml-10">
        <img src={image1} alt="" className="w-full h-full object-fit " />
        </div>
        <div className=" flex justify-center items-center text-white text-center slider  bg-gray-300   md:w-[200px] md:h-[300px] w-[300px] h-[260px]  " >
